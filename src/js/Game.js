...
class JsPacman extends Game {
    ...
    template(model) {
        return `
            <div class="score">
                <div class="p1-score">1er<br /><span>00</span></div>
                <div class="high-score">HIGH SCORE<br /><span>${model.highScore || '00'}</span></div>
                <div class="p2-score">2cnd<br /><span>00</span></div>
            </div>
            ...
            <div class="splash">
                ...
                <div class="credits">&#169; 2023 <span>8</span>FrontHand</div>
            </div>
        `;
    }
}
